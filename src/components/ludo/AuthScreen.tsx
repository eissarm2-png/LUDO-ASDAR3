...
import { Dices, LogIn, LogOut, Mail, ShieldCheck, Trophy, UserPlus } from "lucide-react";
...
export function AuthPanel() {
  ...
  return (
    <div className="space-y-4">
      <div className="grid place-items-center gap-2 mb-4 animate-in slide-in-from-bottom-2 fade-in">
        <div className="relative mb-1 grid size-16 place-items-center rounded-2xl border-2 border-ludo-gold bg-gradient-to-br from-[#8d2a72] to-[#290422] shadow-[0_0_20px_rgba(255,215,0,0.5)]">
          <Dices className="size-9 text-ludo-gold animate-pulse" />
        </div>
        <h1 className="font-display text-3xl sm:text-4xl font-black text-ludo-gold drop-shadow-lg text-center tracking-wide">
          مرحباً بك في عقور لدو
        </h1>
        <p className="text-center text-sm font-semibold text-ludo-soft max-w-xs">
          سجّل الدخول أو أنشئ حسابك لحفظ نقاطك وإحصائياتك والمنافسة على القمة
        </p>
      </div>
