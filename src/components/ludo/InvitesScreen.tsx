    ...
    <div className="space-y-3">
      ...
      {loading ? (
        ...
        <div className="glossy-card py-8 text-center text-sm text-ludo-soft">
          {tab === "incoming" ? (
            <Inbox className="mx-auto mb-2 size-10 text-ludo-gold/70" />
          ) : (
            <Send className="mx-auto mb-2 size-10 text-ludo-gold/70" />
          )}
          لا توجد دعوات هنا
        </div>
      ) : (
            ...
            <article key={inv.id} className="list-card items-start">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <small className="shrink-0 text-[11px] text-ludo-soft">
                    {arabicTime(inv.created_at)}
                  </small>
                </div>
                ...
                >
                  <b className="font-mono text-sm tracking-widest text-ludo-pink">
                    {inv.room_code}
                  </b>
