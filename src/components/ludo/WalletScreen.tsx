      ...
      {tab === "wallet" ? (
        <>
          ...
          <section className="glossy-card space-y-2 p-3">
            <h4 className="relative text-center text-sm font-bold text-ludo-gold">
              كيف تكسب العملات والجواهر
            </h4>
          ...
          {!user && (
            <p className="glossy-card text-center text-xs text-ludo-soft">
              سجّل الدخول لعرض رصيدك وسجل عملياتك.
            </p>
          )}
        </>
      ) : (
