  ...
  head: () => ({
    ...
    meta: [
      ...
      { name: "theme-color", content: "#210a43" },
      {
        name: "description",
        content:
          "لعبة لودو عربية ملكية كاملة: غرف خاصة، نرد ملكي، بطولات، مكافآت، وتحميل مباشر بصيغة APK وأندرويد",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "عبقور لودو" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700;800;900&family=Changa:wght@700;800&display=swap",
      },
      {
        rel: "stylesheet",
